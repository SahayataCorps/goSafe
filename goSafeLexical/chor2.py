...
url2 = 'https://ussouthcentral.services.azureml.net/workspaces/96c958c826904849b74df9dcee941f58/services/5b162bec4dc34142b686b47709562aba/execute?api-version=2.0&details=true'
...
r = requests.post(url = url2, headers = headers, data = body) 
import json
pastebin_url = json.loads(r.text)

res = str(pastebin_url["Results"]["output1"]["value"]["Values"])
'''if '1' in res:
	w = "Non Malicious"
elif '0' in res:
	w = "Malicious"
